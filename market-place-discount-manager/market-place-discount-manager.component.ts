...
@Component({
  selector: 'app-market-place-discount-manager',
  templateUrl: './market-place-discount-manager.component.html',
  styleUrls: ['./market-place-discount-manager.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class MarketPlaceDiscountManagerComponent implements OnInit {
